...
export type AssetLinkingCollections = {
  ...
  callToActionSectionCollection?: Maybe<CallToActionSectionCollection>;
...
export type AssetLinkingCollectionsCallToActionSectionCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
/** This content type is for a blog post. [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/blogPost) */
...
/** Call to action section with background image, heading, subheading, button text and button link [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/callToActionSection) */
export type CallToActionSection = Entry &
  _Node & {
    __typename?: 'CallToActionSection';
    _id: Scalars['ID']['output'];
    backgroundImage?: Maybe<Asset>;
    contentfulMetadata: ContentfulMetadata;
    heading?: Maybe<Scalars['String']['output']>;
    linkedFrom?: Maybe<CallToActionSectionLinkingCollections>;
    subheading?: Maybe<Scalars['String']['output']>;
    sys: Sys;
  };

/** Call to action section with background image, heading, subheading, button text and button link [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/callToActionSection) */
export type CallToActionSectionBackgroundImageArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** Call to action section with background image, heading, subheading, button text and button link [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/callToActionSection) */
export type CallToActionSectionHeadingArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Call to action section with background image, heading, subheading, button text and button link [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/callToActionSection) */
export type CallToActionSectionLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};

/** Call to action section with background image, heading, subheading, button text and button link [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/callToActionSection) */
export type CallToActionSectionSubheadingArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
};

export type CallToActionSectionCollection = {
  __typename?: 'CallToActionSectionCollection';
  items: Array<Maybe<CallToActionSection>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export type CallToActionSectionFilter = {
  AND?: InputMaybe<Array<InputMaybe<CallToActionSectionFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CallToActionSectionFilter>>>;
...
export type CallToActionSectionLinkingCollections = {
  __typename?: 'CallToActionSectionLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};

export type CallToActionSectionLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export enum CallToActionSectionOrder {
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
/** Hero section block. [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/heroSection) */
...
/** [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/page) */
export type Page = Entry &
  _Node & {
    __typename?: 'Page';
    _id: Scalars['ID']['output'];
    builderCollection?: Maybe<PageBuilderCollection>;
    contentfulMetadata: ContentfulMetadata;
...
/** [See type definition](https://app.contentful.com/spaces/2jpxtab97rqb/content_types/page) */
export type PageBuilderCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type PageFilter = {
  ...
  builderCollection_exists?: InputMaybe<Scalars['Boolean']['input']>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  slug?: InputMaybe<Scalars['String']['input']>;
  slug_contains?: InputMaybe<Scalars['String']['input']>;
  slug_exists?: InputMaybe<Scalars['Boolean']['input']>;
...
export type Query = {
  ...
  blogPostCollection?: Maybe<BlogPostCollection>;
  callToActionSection?: Maybe<CallToActionSection>;
  callToActionSectionCollection?: Maybe<CallToActionSectionCollection>;
  entryCollection?: Maybe<EntryCollection>;
...
export type QueryCallToActionSectionArgs = {
  id: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type QueryCallToActionSectionCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<CallToActionSectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  useFallbackLocale?: InputMaybe<Scalars['Boolean']['input']>;
  where?: InputMaybe<CallToActionSectionFilter>;
};
...
export type CallToActionSectionFragment = {
  __typename: 'CallToActionSection';
  heading?: string | null;
...
export type HeroSectionFragment = {
  __typename: 'HeroSection';
  title?: string | null;
  description?: { __typename?: 'HeroSectionDescription'; json: any } | null;
  image?: { __typename?: 'Asset'; url?: string | null; description?: string | null } | null;
};
...
export const CallToActionSectionFragmentDoc = gql`
  fragment CallToActionSection on CallToActionSection {
    __typename
    backgroundImage {
      url
      description
...
export const PageBySlugDocument = gql`
  ...
  ${CallToActionSectionFragmentDoc}
`;
...
const defaultWrapper: SdkFunctionWrapper = (action, _operationName, _operationType, _variables) =>
  action();
const PageBySlugDocumentString = print(PageBySlugDocument);
    ...
    PageBySlug(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<PageBySlugQuery>(PageBySlugDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'PageBySlug',
